...
impl ChefCommand {
    pub fn get_target(&self) -> Rc<dyn Target> {
        match self {
            ...
            ChefCommand::Generate {
                format: GenerateFormat::Iso,
                partition,
                profile,
                page_size,
                frame_size,
            } => todo!(),
            ChefCommand::Run { profile } => todo!(),
            ChefCommand::Debug => todo!(),
            ChefCommand::Check => todo!(),
            ChefCommand::Lint => todo!(),
            ChefCommand::Doc => todo!(),
            ChefCommand::Test => todo!(),
            ChefCommand::Info {
